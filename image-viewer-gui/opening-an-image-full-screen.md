...
* **رقم عائم وخط أحمر في تدرج مؤشر LUT على الجانب الأيمن**
* **عند التكبير أكثر، تظهر القيمة العائمة بالقرب من المؤشر والبكسل المظلل**
* يعرض قيم البكسل **تحت المؤشر أو المظلل**
...
* عرض بيانات JPG كما تمت معاينتها
* عرض القيم الأصلية غير المصححة
* مفيد للتحقق من جودة الصورة قبل المعالجة
...
* يمكن تطبيق LUTs الملونة للتصور

***

## تطبيق المؤشر و LUT

تطبيق المؤشرات متعددة الأطياف وجداول البحث عن الألوان:
...
انظر [Index/LUT Sandbox](index-lut-sandbox.md) للحصول على إرشادات مفصلة.
...
تحقق من صحة حسابات المؤشرات:

1. افتح NDVI أو صورة مؤشر أخرى
2. تحقق من مناطق النباتات:
...
* صورة عائمة 32 بت ذات قيم غير عادية
* خطأ في حساب المؤشر

**الحلول:**

1. تحقق من قيم البكسل - إذا كانت جميعها منخفضة جدًا أو عالية جدًا، فاضبط نطاق العرض
2. حاول فتحها في QGIS أو ما شابه مع ضبط النطاق التلقائي
3. تحقق من سجل التصحيح من المعالجة بحثًا عن الأخطاء
...
للحصول على سير عمل المعالجة، راجع:
