...
* **الصورة التالية**: انقر فوق الزر → أو اضغط على المفتاح **→** (سهم لليمين)
* **الصورة السابقة**: انقر فوق الزر ← أو اضغط على المفتاح **←** (سهم لليسار)
...
* **عند التكبير أكثر، تظهر القيمة العائمة بالقرب من المؤشر والبيكسل المظلل**
...
* صور أحادية النطاق باللون الرمادي
* تمثل قيم البكسل نتائج حساب المؤشر
* النطاق عادةً ما يكون من -1 إلى +1 للمؤشرات المعيارية
* يمكن تطبيق جداول LUT للألوان من أجل التصور

***

## تطبيق المؤشر وجداول LUT
...
4. قم بتطبيق تدرج لوحات الألوان (LUT) للتصور
...
2. تحقق من مناطق الغطاء النباتي:
   ...
   * **GNDVI**: مشابه لـ NDVI ولكن حساس للكلوروفيل
...
2. حاول فتح الملف في QGIS أو ما شابهه مع ضبط النطاق التلقائي
...
* [**صيغ المؤشرات متعددة الأطياف**](../project-settings/multispectral-index-formulas.md) - فهم المؤشرات المتاحة
