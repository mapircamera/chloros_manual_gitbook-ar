...
**يتم الاحتفاظ بتفضيل الطبقة:**

* في حالة عرض &quot;RAW (الانعكاس)&quot;، تعرض الصورة التالية &quot;RAW (الانعكاس)&quot; (إن كانت متوفرة)
* في حالة عرض &quot;RAW (NDVI الفهرس)&quot;، تعرض الصورة التالية &quot;RAW (NDVI الفهرس)&quot; (إن كانت متوفرة)
* إذا لم تكن الطبقة نفسها موجودة، يتم استخدام JPG بشكل افتراضي
...
4. استمر في التنقل - تعرض جميع الصور طبقة NDVI
...
* **تحقق دائمًا من RAW (الأصلية)**: تحقق من جودة البيانات المصدرية قبل الوثوق بالمخرجات المعالجة
...
1. تحقق من معالجة الصورة (تحقق من مجلد الإخراج للملفات المعالجة)
...
3. اضبط إعدادات الكشف عن الأهداف في إعدادات المشروع
...
* **عناصر التحكم في التكبير/التصغير**: قم بالتكبير لفحص التفاصيل
