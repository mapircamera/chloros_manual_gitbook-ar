...
3. قم بإزالة عدد الفئات بالنقر المزدوج على عينة لون
4. يتم تحديث التدرج **في الوقت الفعلي** على الصورة

**التأثير على التصور:**

* **فئات أقل** (3-5): تخلق مناطق متميزة، تصنيف مبسط، فئات أسهل في التمييز
...
* **فئات كثيرة (15-20)**: تحليل علمي، فحص تفصيلي، مخرجات بجودة النشر

### ضبط نطاقات القيم

تحدد **عناصر التحكم في نطاق القيم** أي قيم مؤشر يتم تعيينها لأي ألوان في التدرج اللوني:

**عناصر التحكم في النطاق في لوحة LUT:**

* **القيمة الدنيا**: الحد الأدنى لمقياس الألوان
* **القيمة القصوى**: الحد الأعلى لمقياس الألوان
* **القيم المتوسطة**: موزعة تلقائيًا بين الحد الأدنى والحد الأقصى (بناءً على عدد الفئات)

#### ضبط القيم الدنيا/القصوى

**لضبط نطاقات القيم:**

1. في لوحة LUT، حدد مربعي إدخال **القيمة الدنيا** و**القيمة القصوى**
...
* **كشف الإجهاد**: `0.2` إلى `0.5` (التركيز على المناطق التي تعاني من مشاكل)
* **النطاق المخصص**: اضبط وفقًا لقيم البكسل التي لاحظتها
...
* البكسل **أقل من الحد الأدنى** → العرض باستخدام **اللون الأول** في التدرج (مثل الأحمر)
...
| **خلفية مؤشر**       | تأكيد خفي، الحفاظ على سياق البيانات  | لون على النطاق، رمادي خارج النطاق  |
| **خلفية أصلية**    | التقارير، العروض التقديمية، التحليل البديهي | لون على النطاق، صورة خارج النطاق |

### إنشاء ألوان LUT مخصصة

للتحكم الكامل في التصور الخاص بك، يمكنك إنشاء **تدرجات ألوان مخصصة** عن طريق تحرير نقاط توقف الألوان الفردية.
...
5. اختر لونًا جديدًا باستخدام:
   ...
   * **إدخال رمز سداسي عشري**: مواصفات دقيقة للألوان (على سبيل المثال، `#FF0000` للأحمر)
6. انقر خارج محدد الألوان **لتطبيق اللون الجديد**
7. يتم **تحديث** التدرج اللوني على الصورة على الفور
...
* **تحسين الطباعة**: اختر الألوان التي تناسب الطباعة بالألوان والطباعة بتدرج الرمادي
...
* **تغيير الفئات** → تتحديث سلاسة التدرج على الفور
...
2. **تطبيق المؤشر** - اختر مرشح الكاميرا وصيغة المؤشر، واسحب الدوائر الملونة إلى الموقع المناسب في صيغة المؤشر
3. **تطبيق تدرج LUT** - ابدأ بإعداد Red-Yellow-Green المسبق
...
7. **صقل الألوان** - قم بتخصيص التدرج اللوني إذا لزم الأمر للتأكيد على شيء معين
...
{% hint style=&quot;info&quot; %}
**النطاق الديناميكي**: ستكون هناك نطاقات قيم مختلفة للمحاصيل والمواسم ومراحل النمو المختلفة. افحص دائمًا قيم البكسل في مجموعة البيانات المحددة الخاصة بك قبل تعيين نطاقات LUT.
{% endhint %}

***

## المؤشرات المخصصة (Chloros+)
...
* **معالجة دفعية**: قم بتطبيق الفهارس المحسّنة على مجموعات البيانات الكاملة
