...
* **فئات أقل** (3-5): يخلق مناطق متميزة، وتصنيف مبسط، وفئات أسهل في التمييز
...
* **فئات متوسطة (6-10)**: تحليل عام، تفاصيل متوازنة، تقارير قياسية
...
6. **يتم تحديث** العرض المرئي على الفور
...
* **استبعاد القيم غير ذات الصلة** (على سبيل المثال، المسطحات المائية، التربة الجرداء)
...
* البكسلات **أقل من الحد الأدنى** → العرض باستخدام **اللون الأول** في التدرج (على سبيل المثال، الأحمر)
* البكسلات **أعلى من الحد الأقصى** → العرض باستخدام **اللون الأخير** في التدرج (على سبيل المثال، الأخضر)
...
* تعرض البكسلات **داخل النطاق** **تدرج ألوان**
...
{% hint style=&quot;info&quot; %}
**حفظ التدرجات المخصصة**: يمكن حفظ التدرجات المخصصة وإعادة استخدامها. انقر على أيقونة الحفظ في لوحة LUT لحفظ أنظمة الألوان المخصصة لاستخدامها في المستقبل.
{% endhint %}
...
5. **اضبط الحد الأدنى/الأقصى** - ضيق النطاق للتركيز على الغطاء النباتي (على سبيل المثال، 0.2 إلى 0.9)
