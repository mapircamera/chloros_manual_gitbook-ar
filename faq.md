...
<summary>هل يمكنني تحرير صوري قبل معالجتها في Chloros؟</summary>

لا. يفترض Chloros أن البيانات المدخلة لم يتم تعديلها. لا تقم بتغيير أسماء الملفات.
...
لا. يجب أن تكون مجموعات بيانات الصور Survey3 ذات تعريض ضوئي ثابت/مغلق، لذلك لا يمكن استخدام سرعة الغالق التلقائية أو ISO التلقائي. يجب أن تكون جميع الصور من نفس طراز الكاميرا ذات سرعة غالق وISO (تعريض ضوئي) متطابقين.

</details>

<details>

<summary>هل يمكن لـ Chloros معالجة أو تحليل الصور المركبة؟</summary>

لا. لا يتم دعم سوى صور الكاميرا الفردية MAPIR، ولا يتم دعم الصور المجمعة مثل خريطة الأورثوموزايك.

</details>

<details>

<summary>كيف يمكنني تسريع خطوة الكشف عن الهدف في Chloros؟</summary>

في جدول متصفح الملفات، سيؤدي تحديد الصور المستهدفة مسبقًا في العمود الأيمن إلى إخبار Chloros بالبحث فقط في تلك الصور عن أهداف المعايرة، مما يؤدي إلى تسريع المعالجة بشكل كبير.
