...
تقدم MAPIR أهداف معايرة متنوعة لتغطية مجموعة من التطبيقات. يحتوي جهاز T4-R50 الصغير الموضح أدناه على 4 لوحات تم قياس انعكاس الضوء منها من 250 إلى 2500 نانومتر.
...
<figure><img src=".gitbook/assets/MAPIR Diffuse Reflectance Standard Calibration Target Data T4 (400-1000nm).png" alt=""><figcaption><p>MAPIR T4 الانعكاس :: 400-1000 نانومتر</p></figcaption></figure>بالنظر إلى الرسم البياني للانعكاسية، يمكنك أن ترى أن القيم هي الطول الموجي (المحور x) مقابل نسبة الانعكاسية (المحور y). عندما نلتقط صورة لهدف المعايرة، نقوم بعد ذلك بإنشاء علاقة بين قيمة البكسل ونسبة الانعكاسية، ضمن الطيف الذي تستشعره كل نطاقات مستشعر الكاميرا.
...
إذا قمت بإخراج الصور المعايرة في Chloros كملف JPG أو TIFF نموذجي، فسيتم حساب نسبة الانعكاس عن طريق قسمة قيمة البكسل على عمق بت تنسيق الصورة. لذلك، بالنسبة لملف JPG، قسّم على 255، وبالنسبة لملف TIFF، قسّم على 65535. يمكنك أيضًا اختيار تنسيق PERCENT للإخراج في Chloros، ومن ثم سيتراوح كل بكسل بين قيمة مئوية من 0.0 إلى 1.0 (0% إلى 100% انعكاس). فقط ضع في اعتبارك أن بعض تطبيقات الصور لا تقبل الصور المئوية (النقطة العائمة)، كما أنها كبيرة الحجم من حيث التخزين.
