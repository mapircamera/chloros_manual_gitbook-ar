...
_المصدر: Becker, Sarah J., Craig S.T. Daughtry, and Andrew L. Russ. &quot;مؤشرات غطاء الغابات القوية للصور متعددة الأطياف.&quot; Photogrammetric Engineering &amp; Remote Sensing 84.8 (2018): 505-512._

***

## FCI2 - مؤشر الغطاء الحرجي 2

يميز هذا المؤشر تاج الأشجار عن أنواع النباتات الأخرى باستخدام صور انعكاسية متعددة الأطياف لا تتضمن شريطًا أحمر.

$$
FCI2 = Red * NIR
$$

ستكون قيم FCI2 أقل في المناطق الحرجية بسبب انخفاض انعكاس الأشجار ووجود الظلال داخل الغطاء.
...
يوفر وجود نطاقات طولية واسعة NIR وخضراء توقعات أفضل لمحتوى الكلوروفيل مع توفير حساسية أكبر ونسبة إشارة إلى ضوضاء أعلى.
...
تتراوح قيم LAI العالية عادةً من 0 إلى 3.5 تقريبًا. ومع ذلك، عندما يحتوي المشهد على سحب وخصائص ساطعة أخرى تنتج بكسلات مشبعة، يمكن أن تتجاوز قيم LAI 3.5. من الأفضل إخفاء السحب والسمات الساطعة من المشهد قبل إنشاء صورة LAI.
...
يعتمد هذا المؤشر على مؤشر الغطاء النباتي المعدل حسب التربة (SAVI). ويستخدم قيمة قياسية تبلغ 0.16 لعامل تعديل خلفية الغطاء النباتي. وقد حدد Rondeaux (1996) أن هذه القيمة توفر تباينًا أكبر في التربة مقارنةً بـ SAVI بالنسبة للغطاء النباتي المنخفض، مع إظهار حساسية متزايدة للغطاء النباتي الذي يزيد عن 50٪. ويُفضل استخدام هذا المؤشر في المناطق ذات الغطاء النباتي المتناثر نسبيًا حيث يمكن رؤية التربة من خلال الغطاء النباتي.
...
## RDVI - مؤشر الاختلاف المعدل للنباتات
