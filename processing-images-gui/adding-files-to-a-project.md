...
3. حدد ملف صورة واحدًا أو أكثر (اضغط مع الاستمرار على **Ctrl** لتحديد عدة ملفات)
...
* **تصفية طراز الكاميرا**: قم بتجميع الصور حسب نوع الكاميرا إذا كنت تستخدم عدة كاميرات***
...
* يتم عرض رسالة تحذير عند اكتشاف الملفات المكررة
...
3. يعرض مستعرض الملفات طراز الكاميرا في عمود طراز الكاميرا
...
3. **حدد الصور المستهدفة** - انظر [اختيار الصور المستهدفة](choosing-target-images.md)
