...
قبل معالجة صورك، من المهم تكوين إعدادات مشروعك لتتناسب مع متطلبات سير عملك. توفر لوحة إعدادات المشروع <img src="../.gitbook/assets/icon_project-settings.JPG" alt="" data-size="line"> التحكم الشامل في المعايرة وخيارات المعالجة والمؤشرات متعددة الأطياف وتنسيقات التصدير.

## الوصول إلى إعدادات المشروع

1. افتح مشروعك في Chloros
2. انقر على أيقونة **إعدادات المشروع** <img src="../.gitbook/assets/icon_project-settings.JPG" alt="" data-size="line"> في الشريط الجانبي الأيسر
...
للاطلاع على جميع المؤشرات والصيغ المتاحة، انظر [صيغ المؤشر المتعدد الأطياف](../project-settings/multispectral-index-formulas.md).
...
قم بإنشاء قوالب قابلة لإعادة الاستخدام من أجل سير عمل متسق:
...
* **متى يتم التغيير**:
  ...
  * هيكل مجلدات منظم حسب السنة/العميل
...
* [ ] تنسيق التصدير المناسب لسير عملك
