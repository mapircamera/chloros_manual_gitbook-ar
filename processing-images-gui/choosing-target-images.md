...
* يتم اكتمال اكتشاف الهدف بشكل أسرع
* يتم تقليل وقت المعالجة الإجمالي بشكل كبير

{% hint style=&quot;success&quot; %}
**تحسين السرعة**: يمكن أن يؤدي تحديد 2-3 صور مستهدفة في مجموعة بيانات مكونة من 500 صورة إلى تقليل وقت الكشف عن الأهداف من 30 دقيقة أو أكثر إلى أقل من دقيقة واحدة.
{% endhint %}
...
* من الأفضل التقاط صور الأهداف قدر الإمكان للحصول على أفضل النتائج. وإلا، فسيتم استخدام بيانات مستشعر الضوء لضبط المعايرة بمرور الوقت.
...
1. التقط الصور المستهدفة **بالكاميرتين** في نفس الوقت
2. استخدم **نفس الهدف المادي** لكلا الكاميرتين
3. ضع علامة على الصور المستهدفة **لكلا النوعين من الكاميرات** في مستعرض الملفات
...
قبل بدء المعالجة، تحقق من اختيار صورة الهدف:

* [ ] تم وضع علامة على صورة هدف واحدة على الأقل لكل جلسة
* [ ] تم تحديد مربعات اختيار عمود الهدف لجميع صور الأهداف
...
4. لن يتم معايرة الإخراج للانعكاسية المطلقة
