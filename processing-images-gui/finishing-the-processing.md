...
2. حدد ملف صورة
3. تظهر المعاينة في Windows جزء معاينة مستكشف
4. استخدم مفاتيح الأسهم لتصفح الصور

### المعاينة في عارضات الصور الخارجية

**عارضات الصور الموصى بها:**
...
استخدم عارض الصور المدمج في Chloros للحصول على عرض متقدم:

1. انقر على صورة مصغرة في مستعرض الملفات
2. تفتح الصورة في منطقة المعاينة الرئيسية
3. انقر على علامة التبويب **عارض الصور** <img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line"> في الشريط الجانبي الأيسر
...
### التحقق من التحذيرات أو الأخطاء
...
## مشكلات الإخراج الشائعة وحلولها
...
* **نباتات متفرقة/غير صحية**: 0.2 إلى 0.4
...
4. **معالجة فسيفساء المؤشر**: إنشاء فسيفساء أورثوموزايك NDVI من صور المؤشر الفردية
5. **تصدير GeoTIFF المرجع جغرافيًا**: للاستخدام في تطبيقات GIS
...
4. **إنشاء التقارير**: تضمين الخرائط والإحصاءات والمرئيات
...
* ✅ **الصور الأصلية بتنسيق RAW/JPG** - أرشفة على محرك أقراص/سحابة منفصل
...
1. **حفظ قالب المشروع** (إذا لم يكن قد تم ذلك بالفعل)
...
3. ✅ **ضبط الإعدادات** - انظر [ضبط إعدادات المشروع](adjusting-project-settings.md)
4. ✅ **تم وضع علامة على الأهداف** - انظر [اختيار الصور المستهدفة](choosing-target-images.md)
