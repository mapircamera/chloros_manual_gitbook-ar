...
1. انقر فوق رمز **القائمة الرئيسية** <img src="../.gitbook/assets/image (1) (1) (1) (1).png" alt="" data-size="line"> (أعلى اليسار)
...
**العارضات الموصى بها:*** **QGIS** - برنامج GIS مجاني (الأفضل للتحليل متعدد الأطياف المرجعي جغرافيًا)
...
**نطاقات NDVI المتوقعة:*** **الماء والصخور والتربة**: -0.1 إلى 0.2
* **نباتات متناثرة/غير صحية**: 0.2 إلى 0.4
* **نباتات معتدلة**: 0.4 إلى 0.6
* **نباتات صحية وكثيفة**: 0.6 إلى 0.9**إذا كانت القيم خارج هذه النطاقات:**
...
**ما يجب حفظه:*** ✅ **الصور الأصلية بتنسيق RAW/JPG** - أرشفة على محرك أقراص/سحابة منفصلة
...
* ✅ **صور هدف المعايرة** - للتحقق وإعادة المعالجة**توصيات التخزين:*** **النسخ الاحتياطي الفوري**: محرك أقراص صلب خارجي
...
لعدة جلسات/مجموعات بيانات:**الخيار 1: واجهة المستخدم الرسومية - مشاريع متعددة**
...
7. ✅ **مراجعة النتائج** - هذه الصفحة**صورك متعددة الأطياف المعايرة والمصححة الانعكاسية جاهزة للتحليل!**
