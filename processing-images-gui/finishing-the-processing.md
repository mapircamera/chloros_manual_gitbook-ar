...
2. حدد ملف صورة
3. تظهر المعاينة في جزء المعاينة في مستكشف Windows
...
4. **معالجة فسيفساء المؤشر**: قم بإنشاء فسيفساء NDVI من صور الفهرس الفردية
...
* ✅ **الصور الأصلية بتنسيق RAW/JPG** - قم بالأرشفة على محرك أقراص/سحابة منفصل
...
1. **احفظ قالب المشروع** (إذا لم تكن قد قمت بذلك بالفعل)
2. **أنشئ مشروعًا جديدًا** باستخدام القالب المحفوظ
3. **استورد صورًا جديدة**
4. **قم بالمعالجة** باستخدام إعدادات متطابقة لضمان الاتساق

### معالجة دفعية لعدة جلسات
