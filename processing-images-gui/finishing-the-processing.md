...
* ✅ **زر البدء**: يصبح نشطًا مرة أخرى (جاهز لتشغيل المعالجة التالية)
...
1. **استيراد صور الانعكاس المعايرة** إلى برنامج التصوير المساحي:
   ...
   * DroneDeploy
   * WebODM
2. **الاحتفاظ ببيانات EXIF**: تأكد من الحفاظ على بيانات GPS من أجل وضع العلامات الجغرافية
3. **سير العمل المعاير**: استخدم صور الانعكاس للحصول على دقة علمية
4. **معالجة فسيفساء الفهرس**: قم بإنشاء فسيفساء NDVI من صور الفهرس الفردية
5. **تصدير GeoTIFF المرجعي جغرافيًا**: للاستخدام في تطبيقات GIS

### للتحليل GIS

**سير العمل الموصى به:**

1. **قم بالتحميل إلى QGIS أو ArcGIS أو ما شابه**
...
4. **إنشاء التقارير**: قم بتضمين الخرائط والإحصائيات والمرئيات
